...
Maneja el comando exit de todos los Displayable. Comprueba que el nombre esté en la longitud especificada. Si está, llama a Broadcaster.show(). \begin{DoxySeeAlso}{Ver también}
\hyperlink{classBatallaEspacial_1_1Broadcaster}{Broadcaster} 
\end{DoxySeeAlso}
